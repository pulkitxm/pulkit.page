---
title: Offloading Motion to the GPU
description: Fix janky CSS animations by understanding the rendering pipeline. Learn which
  properties trigger GPU acceleration, why transform beats width, and when to choose CSS over
  JavaScript.
date: 2026-02-03
tags:
  - CSS
...
![Diagram showing the browser rendering pipeline with four stages: Style, Layout, Paint, and Composite](/assets/content/blogs/offloading-motion-to-the-gpu/rendering-pipeline.webp)
...
![Diagram showing frame timing with 16.67ms budgets and dropped frames](/assets/content/blogs/offloading-motion-to-the-gpu/frame-budget.webp)
