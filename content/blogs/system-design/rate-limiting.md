---
title: Rate Limiting
description: Learn how rate limiters protect your systems from being overwhelmed. Understand where
  to place them, why Redis is the go-to database, five popular algorithms, and how to scale with
  sharding. Includes the practical insight of building rate limiters as libraries instead of
  services.
date: 2026-04-11
tags:
  - System Design
...
![Rate limiter either allows or rejects incoming requests](/assets/content/blogs/rate-limiting/rate-limiter-overview.webp)
...
![Rate limiter at the proxy level blocks requests before they reach your service](/assets/content/blogs/rate-limiting/placement-proxy.webp)
...
![Rate limiter as middleware inside the service](/assets/content/blogs/rate-limiting/placement-middleware.webp)
...
![The edge-burst problem in fixed window counters](/assets/content/blogs/rate-limiting/fixed-window-edge.webp)
...
![Comparison of rate limiter as a service versus as a library](/assets/content/blogs/rate-limiting/service-vs-library.webp)
...
![Sharded rate limiter with hash-based routing to Redis shards](/assets/content/blogs/rate-limiting/scaling-sharding.webp)
