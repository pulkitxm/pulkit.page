...
| [work-with-me.md](../apps/page/content/work-with-me.md) | `/work-with-me/` | A screenshot gallery, the Claude Directory/Hinge/Warden posts with their replies carousel, services, a scope and timeline table, the four-step process, grouped tech badges, an FAQ in `details` blocks, and booking links |
