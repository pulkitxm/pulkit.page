...
| [work-with-me.md](../apps/page/content/work-with-me.md) | `/work-with-me/` | Services, scope and timeline table, what every project includes, the four-step process, grouped tech badges, an FAQ in `details` blocks, and booking links |
