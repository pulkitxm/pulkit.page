...
flowchart TD
  ...
  H --> I[Copy shared assets, CSS and theme script]
...
Shiki is shared within the development process and loads requested languages. Bun watches imported server code for restarts. Vite injects its development client for browser reloads and CSS hot replacement; production output has no Vite client. Biome convergence remains checked. See [development benchmarks](development-benchmarks.md) for measurements and limitations.
