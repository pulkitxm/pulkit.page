...
| Stage                                                         | Owner                                                           |
| ------------------------------------------------------------- | --------------------------------------------------------------- |
| Content, layouts, assets, CNAME                               | `apps/page` and `apps/blog`, read relative to the app directory |
...
The apps have no code of their own: their scripts call the engine, and the engine imports the other packages by their workspace names. Because the engine reads `content/`, `layouts/`, `assets/`, `styles.css`, and `CNAME` from the current directory, the same engine builds both apps under `apps/`.
