import { type ButtonStyle, buttonClass, cn } from "./ui.ts";

const spanBase = "flex items-center justify-center gap-2 transition-opacity";

export interface SwapButtonOptions extends Pick<ButtonStyle, "variant" | "size"> {
  swapped?: boolean;
  label1: string;
  label2: string;
  icon?: string;
