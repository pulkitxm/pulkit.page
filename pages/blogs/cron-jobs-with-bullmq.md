...
- URL: https://pulkit.page/blogs/cron-jobs-with-bullmq/
...
![](https://pulkit.page/assets/content/blogs/cron-jobs-with-bullmq/noveum-cron-dash.webp)

![](https://pulkit.page/assets/content/blogs/cron-jobs-with-bullmq/cron-runs.webp)

![](https://pulkit.page/assets/content/blogs/cron-jobs-with-bullmq/create-cron-form.webp)
...
For sending emails as part of your cron jobs (weekly digests, reports, notifications), I've covered that in a [previous post about email delivery with Resend](https://pulkit.page/blogs/contact-form-with-resend.md).
