...
- URL: https://pulkit.page/blogs/design-engineering/the-physics-behind-natural-motion/
...
**Interactive demo: Vercel badge.** [Try it on the page](https://pulkit.page/blogs/design-engineering/the-physics-behind-natural-motion/).
...
**Interactive demo: Spring vs easing.** [Try it on the page](https://pulkit.page/blogs/design-engineering/the-physics-behind-natural-motion/).
...
[Video: ios-dynamic-island.mp4](https://pulkit.page/assets/content/public/series/design-engineering/the-physics-behind-natural-motion/ios-dynamic-island.mp4)
...
**Interactive demo: Spring config playground.** [Try it on the page](https://pulkit.page/blogs/design-engineering/the-physics-behind-natural-motion/).
...
**Interactive demo: Interruptibility.** [Try it on the page](https://pulkit.page/blogs/design-engineering/the-physics-behind-natural-motion/).
...
**Interactive demo: Toast interrupt.** [Try it on the page](https://pulkit.page/blogs/design-engineering/the-physics-behind-natural-motion/).
...
**Interactive demo: Bounce comparison.** [Try it on the page](https://pulkit.page/blogs/design-engineering/the-physics-behind-natural-motion/).
...
**Interactive demo: Perceptual duration.** [Try it on the page](https://pulkit.page/blogs/design-engineering/the-physics-behind-natural-motion/).
...
**Interactive demo: Easing curve.** [Try it on the page](https://pulkit.page/blogs/design-engineering/the-physics-behind-natural-motion/).
