...
- URL: https://pulkit.page/blogs/design-engineering/when-to-animate-and-when-to-skip/
...
**Interactive demo: Purpose.** [Try it on the page](https://pulkit.page/blogs/design-engineering/when-to-animate-and-when-to-skip/).
...
**Interactive demo: Frequency toggle.** [Try it on the page](https://pulkit.page/blogs/design-engineering/when-to-animate-and-when-to-skip/).
...
**Interactive demo: Keyboard nav.** [Try it on the page](https://pulkit.page/blogs/design-engineering/when-to-animate-and-when-to-skip/).
...
**Interactive demo: Duration comparison.** [Try it on the page](https://pulkit.page/blogs/design-engineering/when-to-animate-and-when-to-skip/).
...
**Interactive demo: Spinner speed.** [Try it on the page](https://pulkit.page/blogs/design-engineering/when-to-animate-and-when-to-skip/).
...
**Interactive demo: Tooltip delay.** [Try it on the page](https://pulkit.page/blogs/design-engineering/when-to-animate-and-when-to-skip/).
...
**Interactive demo: Element size.** [Try it on the page](https://pulkit.page/blogs/design-engineering/when-to-animate-and-when-to-skip/).
...
**Interactive demo: Product vs marketing.** [Try it on the page](https://pulkit.page/blogs/design-engineering/when-to-animate-and-when-to-skip/).
