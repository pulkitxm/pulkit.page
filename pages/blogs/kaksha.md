...
- URL: https://pulkit.page/blogs/kaksha/
...
![A handwritten list on school notepaper next to an Android tablet running the Kaksha app. The list reads: 1 Teachers Add/Del, 2 Sub Add/Del, 3 Full Tr. Time Table, 4 Clash of T.T., 5 Sub-Tr (Data feed), 6 Notes, with a boxed mapping of class numbers to section letters underneath.](https://pulkit.page/assets/content/public/blogs/kaksha/paper-and-tablet.webp)
...
![The Kaksha timetable screen on an Android tablet. Sections A and B are shown as rows, periods 0 to 6 as columns, and each cell holds coloured subject chips with teacher names underneath.](https://pulkit.page/assets/content/public/blogs/kaksha/timetable-grid.webp)
...
![The Kaksha clashes screen listing four teacher overlaps. Each card names a teacher, says 'Booked in two places at once', and lists the conflicting sections, subjects and the period and days involved.](https://pulkit.page/assets/content/public/blogs/kaksha/clash-detection.webp)
...
![The Kaksha teachers screen showing a sample staff list. Each row has a teacher's name, their department and slot count, a green load bar, subject chips, and their weekly lecture count on the right.](https://pulkit.page/assets/content/public/blogs/kaksha/teacher-load.webp)
...
![The Kaksha share screen. A dropdown selects a teacher, a light and dark style toggle sits below it, a rendered weekly timetable card is previewed, and there are 'Preview image' and 'Share as image' buttons at the bottom.](https://pulkit.page/assets/content/public/blogs/kaksha/share-screen.webp)
...
![An exported timetable card for a single teacher, showing 27 lectures per week across classes VI, VII, VIII and X, laid out as periods by weekday with colour-coded subject blocks.](https://pulkit.page/assets/content/public/blogs/kaksha/teacher-export.webp)
...
- [My First Talk: Claude Directory](https://pulkit.page/blogs/my-first-talk.md): June 13, 2026
