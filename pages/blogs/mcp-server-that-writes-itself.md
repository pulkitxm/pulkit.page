...
- URL: https://pulkit.page/blogs/mcp-server-that-writes-itself/
...
![MCP session sequence: Client and Server exchange initialize, serverInfo, notifications/initialized, tools/list, resources/list, prompts/list, and tools/call with JSON-RPC style messages.](https://pulkit.page/assets/content/blogs/mcp-server-that-writes-itself/typical-session.webp)
...
If you want to trade notes on large APIs, weird schemas, or prompts for long-running jobs, you can use my [contact form](https://pulkit.page/contact.md).
