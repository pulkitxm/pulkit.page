...
- URL: https://pulkit.page/blogs/sse-with-fastapi/
...
![Terminal showing Python virtual environment activation](https://pulkit.page/assets/content/blogs/server-sent-events-with-fastapi/bc758d6d-c914-4c4a-bf5d-8dfbf2ce3183.webp)

```bash
pip install fastapi sse-starlette uvicorn asyncio
```

![Terminal showing FastAPI dependencies installation](https://pulkit.page/assets/content/blogs/server-sent-events-with-fastapi/2c5d09d7-fa01-46f2-9f38-21ebc2587012.webp)
...
![Terminal showing FastAPI server running](https://pulkit.page/assets/content/blogs/server-sent-events-with-fastapi/6c00af74-1de9-46c1-b6e3-eee5ff533c99.webp)
...
![Browser showing SSE stream response](https://pulkit.page/assets/content/blogs/server-sent-events-with-fastapi/99b548a0-2158-4379-9306-8f6175079f12.webp)

You can even see the same response in the developer tools.

![Browser developer tools showing SSE events](https://pulkit.page/assets/content/blogs/server-sent-events-with-fastapi/215331ad-97a2-4797-b0cb-647eea17584f.webp)
...
- [Python Dependency Management with Poetry](https://pulkit.page/blogs/python-poetry-guide.md): July 13, 2024
