...
- URL: https://pulkit.page/blogs/system-design/async-processing/
...
![User sends request and server handles it immediately - this is synchronous](https://pulkit.page/assets/content/blogs/async-processing/sync.webp)
...
![Long-running tasks shouldn't block the user](https://pulkit.page/assets/content/blogs/async-processing/async.webp)
...
![Typical async flow with API, broker, and workers](https://pulkit.page/assets/content/blogs/async-processing/async-flow.webp)
...
![Message queues help services communicate through messages](https://pulkit.page/assets/content/blogs/async-processing/message-queues.webp)
...
![Brokers buffer messages - consumers process at their own pace](https://pulkit.page/assets/content/blogs/async-processing/message-buffering.webp)
...
![If consumer crashes before deleting, message reappears](https://pulkit.page/assets/content/blogs/async-processing/message-requque.webp)
...
![Image upload triggers async processing for multiple sizes](https://pulkit.page/assets/content/blogs/async-processing/image-processing.webp)
...
![AWS SQS is a managed message queue](https://pulkit.page/assets/content/blogs/async-processing/amazon-sqs.webp)
...
![RabbitMQ is an open-source message broker](https://pulkit.page/assets/content/blogs/async-processing/rabbitmq.webp)
...
![One broker with consumer doing multiple things](https://pulkit.page/assets/content/blogs/async-processing/streams-approach-1.webp)
...
![Two brokers with two sets of consumers](https://pulkit.page/assets/content/blogs/async-processing/streams-approach-2.webp)
...
![Message streams allow multiple consumer types to read the same message](https://pulkit.page/assets/content/blogs/async-processing/streams-vs-queues.webp)
...
![Using Kafka with multiple consumer types](https://pulkit.page/assets/content/blogs/async-processing/streams-approach-3.webp)
...
![Kafka is a distributed streaming platform](https://pulkit.page/assets/content/blogs/async-processing/kafka.webp)
...
![A topic split into multiple partitions, each with sequential offsets](https://pulkit.page/assets/content/blogs/async-processing/topics-partitions.webp)
...
![Pub/Sub pushes messages to subscribers instead of them pulling](https://pulkit.page/assets/content/blogs/async-processing/pubsub.webp)
