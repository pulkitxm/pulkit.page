...
- URL: https://pulkit.page/blogs/system-design/caching/
...
![Caching is a technique to avoid expensive operations by storing frequently accessed data in faster storage](https://pulkit.page/assets/content/blogs/caching/cache-db.webp)
...
![The typical caching architecture looks like this](https://pulkit.page/assets/content/blogs/caching/request-flow.webp)
...
![Redis is the most popular caching solution today](https://pulkit.page/assets/content/blogs/caching/redis.webp)
...
![Memcached is simpler than Redis. It's a pure key-value store without the advanced data structures. It's lightweight and fast, good for simple caching needs](https://pulkit.page/assets/content/blogs/caching/memcached.webp)
...
![Populating the cache](https://pulkit.page/assets/content/blogs/caching/populating-cache.webp)
...
![Lazy population means you don't proactively push data into the cache. Instead, you let requests come in, experience cache misses, and then populate the cache.](https://pulkit.page/assets/content/blogs/caching/lazy-update.webp)
...
![Eager population](https://pulkit.page/assets/content/blogs/caching/eager-update.webp)
...
![Scaling the cache](https://pulkit.page/assets/content/blogs/caching/scaling.webp)

Cache is just a faster database. The scaling techniques are identical to how you'd scale any database. I wrote about scaling databases in depth here as well -> "[Before You Scale](https://pulkit.page/blogs/system-design/understanding-database-scaling-sharding.md#before-you-scale)".
...
![Caching at different levels](https://pulkit.page/assets/content/blogs/caching/caching-at-different-levels.webp)
...
![Client-side caching](https://pulkit.page/assets/content/blogs/caching/client-side-cache.webp)
...
![Content Delivery Networks](https://pulkit.page/assets/content/blogs/caching/cdn.webp)
...
![Remote cache](https://pulkit.page/assets/content/blogs/caching/remote-cache.webp)
