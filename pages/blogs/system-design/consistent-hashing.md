...
- URL: https://pulkit.page/blogs/system-design/consistent-hashing/
...
![Hash-based routing uses a hash function to determine which server handles each request](https://pulkit.page/assets/content/blogs/consistent-hashing/hash-based-routing.webp)
...
![The rehashing problem causes massive data movement when nodes change](https://pulkit.page/assets/content/blogs/consistent-hashing/rehashing-problem.webp)
...
![Consistent hashing ring with nodes placed at hash positions, keys owned by next clockwise node](https://pulkit.page/assets/content/blogs/consistent-hashing/ring.webp)
...
![Adding a node only affects keys in a small range between the new node and its left neighbor](https://pulkit.page/assets/content/blogs/consistent-hashing/scale-up.webp)
