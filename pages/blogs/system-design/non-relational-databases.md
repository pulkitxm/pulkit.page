...
- URL: https://pulkit.page/blogs/system-design/non-relational-databases/
- Published: January 8, 2026
- Tags: Database, NoSQL, MongoDB, Redis, Neo4j
- Part of: [System Design](https://pulkit.page/blogs/system-design.md)

![Non-Relational Databases](https://pulkit.page/assets/content/blogs/non-relational-databases/types.webp)
...
![Document DB](https://pulkit.page/assets/content/blogs/non-relational-databases/document-db.webp)
...
![Key-Value DB](https://pulkit.page/assets/content/blogs/non-relational-databases/key-value-db.webp)
...
![Graph DB](https://pulkit.page/assets/content/blogs/non-relational-databases/graph-db.webp)
