...
- URL: https://pulkit.page/blogs/system-design/understanding-database-scaling-sharding/
...
![Diagram showing vertical scaling by adding more CPU, RAM, and disk to a single server](https://pulkit.page/assets/content/blogs/database-scaling/vertical-scaling.webp)
...
![Diagram showing horizontal scaling by adding multiple servers to distribute load](https://pulkit.page/assets/content/blogs/database-scaling/horizontal-scaling.webp)
...
![Diagram showing primary database with multiple read replicas for scaling read operations](https://pulkit.page/assets/content/blogs/database-scaling/read-replicas.webp)
...
![Diagram showing data distributed across multiple database shards](https://pulkit.page/assets/content/blogs/database-scaling/sharding.webp)
...
![Diagram comparing sharding across servers vs partitioning within a single server](https://pulkit.page/assets/content/blogs/database-scaling/sharding-vs-partioning.webp)
...
![Diagram showing horizontal partitioning splitting data by rows](https://pulkit.page/assets/content/blogs/database-scaling/horizontal-partitioning.webp)
...
![Diagram showing vertical partitioning splitting data by columns](https://pulkit.page/assets/content/blogs/database-scaling/vertical-partitioning.webp)
...
- [Database Transaction Internals: ACID, WAL, MVCC & Locking](https://pulkit.page/blogs/system-design/db-transaction-internals.md): January 3, 2026
