...
> Full Stack Engineer internship at Datawave Labs, developing scalable cloud-driven data intelligence platform with authentication systems, cloud integrations (AWS, Azure, GCP), infrastructure automation, and real-time notifications.

- URL: https://pulkit.page/exp/datawavelabs/
...
![DatawaveLabs Dashboard](https://pulkit.page/assets/content/exp/datawavelabs/datawaveDashboard.webp)
...
- [Offer Letter](https://pulkit.page/assets/content/exp/datawavelabs/offer-letter.pdf) (PDF)
- [Relieving Letter](https://pulkit.page/assets/content/exp/datawavelabs/relieving-letter.pdf) (PDF)
- [Practical Report](https://pulkit.page/assets/content/exp/datawavelabs/practical-training-report.pdf) (PDF)
