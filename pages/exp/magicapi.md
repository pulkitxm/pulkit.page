...
> Working as a Software Engineer at API.market (MagicAPI), responsible for improving user experience, implementing new features, code quality improvements, wallet system, voucher system, and redesigning key platform components.

- URL: https://pulkit.page/exp/magicapi/
- Role: Software Engineer
- Period: Mar 2025 – present
- Part of: [Experience](https://pulkit.page/exp.md)
...
![API.market Website](https://pulkit.page/assets/content/exp/magicapi/website.webp)
...
![Responsiveness Comparison](https://pulkit.page/assets/content/exp/magicapi/resp-comparison.webp)
...
![Seller Dashboard](https://pulkit.page/assets/content/exp/magicapi/seller-dash.webp)

### Added Wallet system for users to add and store funds

![Wallet System](https://pulkit.page/assets/content/exp/magicapi/wallet.webp)
...
![Transaction Popup](https://pulkit.page/assets/content/exp/magicapi/transaction-popup.webp)
...
![Voucher System](https://pulkit.page/assets/content/exp/magicapi/voucher.webp)
...
![](https://pulkit.page/assets/content/exp/magicapi/user-specific-vouchers.webp)

![](https://pulkit.page/assets/content/exp/magicapi/public-vouchers.webp)
...
[Video: New Hero Section](https://pulkit.page/assets/content/exp/magicapi/new-hero-section.mp4)
...
![](https://pulkit.page/assets/content/exp/magicapi/smart-onboarding-form/step-1.webp)

![](https://pulkit.page/assets/content/exp/magicapi/smart-onboarding-form/step-2.webp)

![](https://pulkit.page/assets/content/exp/magicapi/smart-onboarding-form/step-3.webp)
...
![Noveum Dash](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/original-dash.webp)
...
![](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/traces/main-view.webp)

![](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/traces/with-span.webp)

![](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/traces/flow-chart.webp)

![](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/traces/date-selector.webp)
...
![](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/datasets/datasets.webp)

![](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/datasets/example-dataset-items.webp)

![](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/datasets/chat-ui.webp)

![](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/datasets/scorer-ui.webp)

![](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/datasets/json-view.webp)
...
![](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/etl-job/etl-jobs.webp)

![](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/etl-job/mapper-agent.webp)

![](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/etl-job/trace-picker.webp)

![](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/etl-job/complete-trace-view.webp)

![](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/etl-job/create-job.webp)

![](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/etl-job/mapper-code.webp)

![](https://pulkit.page/assets/content/exp/magicapi/noveum.ai/etl-job/etl-job-runs.webp)
...
- [Offer Letter](https://pulkit.page/assets/content/exp/magicapi/offer-letter.pdf) (PDF)
- [Internship Completion Letter](https://pulkit.page/assets/content/exp/magicapi/internship-completion-letter.pdf) (PDF)
